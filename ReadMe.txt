 ...
 REST API: Приложение предоставляет RESTful API для взаимодействия с клиентской частью.
...
changelog-0001-init.sql: Создание таблиц (например, categories, products, orders и т.д.).
